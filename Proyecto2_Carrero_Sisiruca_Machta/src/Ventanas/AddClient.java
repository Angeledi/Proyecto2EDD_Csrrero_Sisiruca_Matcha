...
public class AddClient extends javax.swing.JFrame {
    ...
    public AddClient(HashTableEstadoActual Estado, ABB_Reserva Reserva, BinarySearchTree Historico, ListaHabitacion list_habitaciones) {
        initComponents();
        this.Estado = Estado;
    ...
    private void AddClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddClientActionPerformed
       // gender.add(Male);
        ...
        if (!"".equals(nombre) & !"".equals(apellido) & !"".equals(email) & !"".equals(celular) & gender.getSelection() != null & tipoHabitacion != null){
            try {
